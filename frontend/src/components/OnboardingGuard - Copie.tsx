// src/components/OnboardingGuard.tsx - VERSION CORRIGÉE FINAL
...
// ✅ CORRIGÉ - Routes autorisées APRÈS questionnaire complété
const ALLOWED_ROUTES_AFTER_QUESTIONNAIRE = [
  '/',
  '/decouverte',            // ✅ CORRIGÉ : /discovery → /decouverte
  '/chat',
  '/profile',
